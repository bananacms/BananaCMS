    ...
    public function initDefaults(): int
    {
        $defaults = [
            ...
            [
                'page_slug' => 'dmca',
                'page_title' => 'DMCA',
                'page_content' => '<h2>DMCA</h2><p>本站尊重并保护知识产权，根据《数字千年版权法》(DMCA)的规定，我们将对涉嫌侵权内容采取相应措施。</p><h3>版权投诉</h3><p>如果您认为本站上的内容侵犯了您的版权，请向我们提供以下信息：</p><ul><li>您声称被侵权的版权作品的描述</li><li>涉嫌侵权内容在本站的具体位置（URL链接）</li><li>您的联系方式（地址、电话、邮箱）</li><li>您声明善意相信该内容的使用未经版权所有者授权</li><li>您声明投诉信息准确无误</li><li>您的签名（电子签名或手写签名）</li></ul><h3>处理流程</h3><p>收到有效的版权投诉后，我们将在24-48小时内进行审核处理。</p><h3>联系方式</h3><p>请将版权投诉发送至：admin@example.com</p><p>我们承诺认真对待每一份投诉，并依法保护版权所有者的合法权益。</p>',
                'page_sort' => 6,
                'page_status' => 1,
                'page_footer' => 1
            ]
