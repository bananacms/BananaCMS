<div class="mb-6">
    <div class="flex items-center gap-4 mb-4">
        <a href="/admin.php/short/episodes/<?= $short['short_id'] ?>" class="text-gray-500 hover:text-gray-700">← 返回剧集列表</a>
...
<form method="post" action="/admin.php/short/<?= isset($episode) ? 'doEditEpisode/' . $episode['episode_id'] : 'doAddEpisode/' . $short['short_id'] ?>" class="bg-white rounded shadow p-6 max-w-2xl">
    ...
    <div class="mt-6 pt-4 border-t flex gap-4">
        ...
        <a href="/admin.php/short/episodes/<?= $short['short_id'] ?>" class="bg-gray-200 text-gray-700 px-6 py-2 rounded hover:bg-gray-300">
            取消
        </a>
    </div>
</form>
