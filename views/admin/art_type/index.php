...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="/admin.php/art_type/add" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
        + 添加分类
    </a>
</div>
        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-sm space-x-2">
                    <a href="/admin.php/art_type/edit/<?= $type['type_id'] ?>" class="text-blue-500 hover:underline">编辑</a>
