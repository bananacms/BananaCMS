<div class="max-w-2xl">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="/<?= $adminEntry ?>?s=link/<?= isset($link) ? 'doEdit/' . $link['link_id'] : 'doAdd' ?>" method="post" class="space-y-4">
            ...
            <div class="flex gap-4 pt-4">
                ...
                <a href="/<?= $adminEntry ?>?s=link" class="px-6 py-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200">返回</a>
            </div>
        </form>
    </div>
</div>
