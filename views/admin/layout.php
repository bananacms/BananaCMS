    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-gray-900 min-h-screen text-white fixed left-0 top-0 bottom-0 flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1">
                ...
                <a href="/<?= $adminEntry ?>/ai" class="sidebar-link block px-4 py-2 rounded hover:bg-gray-800 <?= strpos($_SERVER['REQUEST_URI'], '/ai') !== false && strpos($_SERVER['REQUEST_URI'], '/ai') === strrpos($_SERVER['REQUEST_URI'], '/ai') ? 'active' : '' ?>">
                    <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-shrink-0 p-4 border-t border-gray-800">
                ...
                <a href="/<?= $adminEntry ?>/password" class="block text-center px-4 py-2 mb-2 bg-gray-700 rounded hover:bg-gray-600 text-sm">
                    <svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
