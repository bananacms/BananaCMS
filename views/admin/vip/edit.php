    ...
    <form method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div>
                ...
                <input type="number" name="price" value="<?= $package['package_price'] ?? '' ?>" 
            ...
            <div>
                ...
                <input type="number" name="price_usdt" value="<?= $package['package_price_usdt'] ?? '' ?>" 
            ...
            <div>
                ...
                <input type="number" name="original_price" value="<?= $package['package_original'] ?? '' ?>" 
                    class="w-full border rounded px-3 py-2" step="0.01" min="0">
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4">
            <div>
                ...
                <input type="number" name="days" value="<?= $package['package_days'] ?? 30 ?>" 
            ...
            <div>
                ...
                <input type="number" name="daily_limit" value="<?= $package['package_daily_limit'] ?? 9999 ?>" 
            ...
            <div>
                ...
                <input type="number" name="bonus_days" value="<?= $package['package_bonus_days'] ?? 0 ?>" 
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" name="bonus_points" value="<?= $package['package_bonus_points'] ?? 0 ?>" 
                    class="w-full border rounded px-3 py-2" min="0">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">排序</label>
                <input type="number" name="sort" value="<?= $package['package_sort'] ?? 0 ?>" 
                    class="w-full border rounded px-3 py-2" min="0">
            </div>
        </div>
        ...
        <div>
            ...
            <input type="text" name="description" value="<?= htmlspecialchars($package['package_desc'] ?? '') ?>" 
                class="w-full border rounded px-3 py-2" placeholder="如: 热门推荐">
        </div>
        
        <div class="flex gap-6">
            <label class="flex items-center">
                <input type="checkbox" name="is_hot" value="1" <?= !empty($package['package_hot']) ? 'checked' : '' ?> class="mr-2">
                <span>热门推荐</span>
            </label>
            <label class="flex items-center">
                <input type="radio" name="status" value="1" <?= ($package['package_status'] ?? 1) == 1 ? 'checked' : '' ?> class="mr-2">
                <span>上架</span>
            </label>
            <label class="flex items-center">
                <input type="radio" name="status" value="0" <?= ($package['package_status'] ?? 1) == 0 ? 'checked' : '' ?> class="mr-2">
                <span>下架</span>
            </label>
        </div>
