<div class="flex justify-between items-center mb-6">
    ...
    <a href="/<?= $adminEntry ?>?s=transcode" class="text-gray-500 hover:text-gray-700">← 返回列表</a>
</div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div id="uploadComplete" class="mt-6 text-center hidden">
                ...
                <div class="mt-6 flex justify-center gap-4">
                    ...
                    <a href="/<?= $adminEntry ?>?s=transcode" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-2 rounded">查看任务</a>
                </div>
            </div>
