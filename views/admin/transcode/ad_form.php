<div class="flex justify-between items-center mb-6">
    ...
    <a href="/<?= $adminEntry ?>?s=transcode/ad" class="text-gray-500 hover:text-gray-700">← 返回列表</a>
</div>
...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form method="post" class="space-y-6">
        ...
        <div class="flex gap-4 pt-4">
            ...
            <a href="/<?= $adminEntry ?>?s=transcode/ad" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-6 py-2 rounded">取消</a>
        </div>
    </form>
</div>
