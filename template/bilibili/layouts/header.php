            ...
            <div class="h-14 flex items-center justify-between">
                <div class="flex items-center space-x-4 md:space-x-6">
                    ...
                    <a href="/" class="flex items-center">
                        ...
                        <?php else: ?>
                        <span class="text-pink-500 text-xl md:text-2xl font-bold">( ゜- ゜)つロ <?php echo $siteName ?? SITE_NAME; ?></span>
                        <?php endif; ?>
                    </a>
                ...
                <div class="border-t pt-4 mt-4">
                    ...
                    <?php if (!empty($navTypes)): ?>
                        <?php foreach ($navTypes as $navItem): ?>
                            <a href="<?php echo xpk_page_url('type', ['id' => $navItem['type_id'], 'slug' => $navItem['type_en']]); ?>" class="block text-lg text-gray-600 py-2 hover:text-pink-500"><?php echo htmlspecialchars($navItem['type_name']); ?></a>
                        <?php endforeach; ?>
                    <?php endif; ?>
